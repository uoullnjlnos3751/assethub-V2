...
const pmWorkflowSteps = [
  ...
  },
  {
    ...
    actorColor: 'secondary',
    desc: 'ช่างเทคนิคหรือผู้ดูแลระบบ เข้าตรวจเช็คอุปกรณ์จริงตามหน้างาน และทำรายการบันทึกคะแนนประเมินผ่านมือถือหรืออุปกรณ์พกพาในเมนู "ทำ PM ทรัพย์สิน" หรือเมนู "ตู้ Switch/Hub"',
