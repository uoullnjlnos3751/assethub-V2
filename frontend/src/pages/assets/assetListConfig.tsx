...
export const defaultColumnConfig: ColumnConfig[] = [
  ...
  { field: 'custodyHolder', label: 'จุดรับฝาก', visible: false },
  { field: 'custodyUpdatedAt', label: 'รับฝากเมื่อ', visible: false },
...
export const COLUMN_CATEGORIES: Record<string, string> = {
  ...
  custodyHolder: 'องค์กร/ตำแหน่ง', custodyUpdatedAt: 'องค์กร/ตำแหน่ง',
